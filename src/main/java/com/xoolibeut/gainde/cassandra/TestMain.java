...
public class TestMain {
	...
	public static void main(String[] args) {
		...
		try {
			...
			long count = cassandraRepositoryImpl.countAllRows("DMZ", "xb415c59b_006d_4f39_825e_6efb0c9cce0a_group_2", "api_portal_portalorganizationstore");
			...
			System.out.println(mapper.writeValueAsString(gaindeMetadataDTO));
